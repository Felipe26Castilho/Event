...
public class EventoEntity {
	...
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	 ...
	 private LocalDate dtncerramento;
	 
	 
	 
	public LocalDate getDtncerramento() {
		return dtncerramento;
	}
	public void setDtncerramento(LocalDate dtncerramento) {
		this.dtncerramento = dtncerramento;
	}
	public Long getId() {
		return id;
	}
